...
export const MyNotifications: React.FC<MyNotificationsProps> = ({ searchTerm }) => {
  ...
  return (
    <div className="space-y-xl relative">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-md">
        <div>
          <h1 className="font-headline-lg text-headline-lg text-on-surface mb-xs">Welfare Alerts Inbox</h1>
          <p className="text-on-surface-variant font-body-md">
            Personalized welfare recommendations and public service matches.
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-sm">
          {filteredAlerts.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-2xl border border-dashed border-outline-variant bg-surface-container-low/30 rounded-xl">
              <span className="material-symbols-outlined text-[64px] text-outline-variant mb-md">inbox</span>
              <p className="text-on-surface-variant font-label-md">Inbox empty. Run generator matches in admin panel.</p>
            </div>
          ) : (
